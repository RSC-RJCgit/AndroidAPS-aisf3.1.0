...
class DetermineBasalAutoISF @Inject constructor(
    ...
    */
    ...
    fun determine_basal(
        ...
        if (autoIsfMode) {
            consoleError.add("--------------- -------------------")
            consoleError.add("start AutoISF ${profile.autoISF_version}Nrsn096")
            consoleError.add("----------------------------------")
        ...
        rT.reason.append(
            "Nrsn096 COB: ${round(meal_data.mealCOB, 1).withoutZeros()}, Dev: ${convert_bg(deviation.toDouble())}, BGI: ${convert_bg(bgi)}, ISF: ${convert_bg(sens)}, CR: ${
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        if (iob_data.iob > max_iob) {
            ...
            if (microBolusAllowed && enableSMB && bg > threshold) {
                ...
                if ( SMBInterval == 1 && bg > 7.0 * 18 && lastBolusAge > 2 * SMBInterval - 6.0) {
                ...
                }else if ( SMBInterval == 1 && bg > 7.0 * 18 && lastBolusAge > 3 * SMBInterval - 6.0) {
